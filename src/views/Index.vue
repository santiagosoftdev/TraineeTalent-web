        ...
        <div class="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
          <div class="pt-32 sm:pt-0">
            <h2 class="font-semibold text-4xl text-blueGray-600">
              TraineeTalent - Una Gran Oportunidad de encontrar Talento.
            </h2>
            <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
              TraineeTalent es ina pagina para programadores, ingenieros, desarrolladores de software con la finalidad de impulsarlos al mercado.
              <a
                href="https://tailwindcss.com/?ref=creativetim"
                class="text-blueGray-600"
                target="_blank"
              >
                Gana puntos completando las dinamicas
              </a>
              comienza demostrando tus habilidades con las 3 capas basicas del desarrollo de aplicaciones | Frontend | Backend | Bases de Datos
            </p>
            <div class="mt-12">
              <a
